-- PROCEDURE: public.proc_validate_users_stg(bigint)

-- DROP PROCEDURE IF EXISTS public.proc_validate_users_stg(bigint);

CREATE OR REPLACE PROCEDURE public.proc_validate_users_stg(
...
END;
$BODY$;
ALTER PROCEDURE public.proc_validate_users_stg(bigint)
    OWNER TO postgres;
